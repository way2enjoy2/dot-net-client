...
[assembly:InternalsVisibleTo("Way2enjoy.Tests")]
namespace Way2enjoy
{
    public class Way2enjoyClient : IDisposable
    {
        ...
        public Way2enjoyClient(string apiKey)
        {
        ...
        /// <returns>Way2enjoyApiResult, <see cref="Way2enjoyApiResult"/></returns>
        public async Task<Way2enjoyCompressResponse> Compress(string pathToFile)
        {
        ...
        /// <returns></returns>
        public async Task<Way2enjoyCompressResponse> Compress(byte[] data)
        {
            if (data == null)
        ...
        /// <returns></returns>
        public async Task<Way2enjoyCompressResponse> Compress(Stream data)
        {
            if (data == null)
                throw new ArgumentNullException(nameof(data));
            ...
            {
                return new Way2enjoyCompressResponse(response, HttpClient);
            }
        ...
        /// <returns></returns>
        public async Task<Uri> SaveCompressedImageToAmazonS3(Way2enjoyCompressResponse result, AmazonS3Configuration amazonSettings, string path)
        {
            if (result == null)
        ...
        /// <returns></returns>
        public Task<Uri> SaveCompressedImageToAmazonS3(Way2enjoyCompressResponse result, string path, string bucketOverride = "", string regionOverride = "")
        {
            if (result == null)
                throw new ArgumentNullException(nameof(result));
